  ...
  return (
    <div className="auth-page">
      <section className="auth-left">
        ...
        <div className="feature-list" aria-label="FakeGuard features">
          <button
            type="button"
            onClick={() => navigate("/community-alert")}
            aria-label="Open community fake product alerts"
          >
            <span className="feature-check">✓</span>
            <span className="feature-text">Community fake product alerts</span>
            <span className="feature-arrow" aria-hidden="true">→</span>
          </button>

          <button
            type="button"
            onClick={() => navigate("/geo-verification")}
            aria-label="Open geo-location based verification"
          >
            <span className="feature-check">✓</span>
            <span className="feature-text">Geo-location based verification</span>
            <span className="feature-arrow" aria-hidden="true">→</span>
          </button>

          <button
            type="button"
            onClick={() => navigate("/chain-trace")}
            aria-label="Open supply chain traceability"
          >
            <span className="feature-check">✓</span>
            <span className="feature-text">Supply chain traceability</span>
            <span className="feature-arrow" aria-hidden="true">→</span>
          </button>
        </div>
      </section>
